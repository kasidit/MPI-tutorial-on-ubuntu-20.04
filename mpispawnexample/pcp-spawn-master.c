...
void makehostlist(int num, char *, const char *, int *);
...
int main(int argc, char *argv[])
{
    ...
    int numnewhost = 1; 
    makehostlist(numnewhost+1, argv[1], "targets", &num_hosts);
...
*/
void makehostlist(int num, char *list, const char* fname, int *nfound)
{
    char *p;
